    ...
    <div class="prl-grid prl-grid-divider">  
        <section id="main" class="prl-span-9"> 
			...
			<article id="article-single"> 
				<h1><a href="single_movie_post.php?movie_title=<?php echo $_SESSION['movie_title']; ?>"><?php echo $movie_title; ?></h1></a>
