...
include('includes/connection.php');
	...
	{
		$political_title = $_GET['delete_title'];
			$sql = "DELETE FROM political WHERE political_title = ? ";
    ...
    <div class="prl-grid prl-grid-divider">  
        <section id="main" class="prl-span-12"> 
			...
			<article id="article-single"> 
				<h1><a href="a_single_political_post.php?political_title=<?php echo $_SESSION['political_title']; ?>"><?php echo $political_title; ?><a href="a_single_political_post.php?delete_title=<?php echo $political_title; ?>" style="float:right;font-size:15px;color:red;">Delete</a><a href="a_single_political_post_edit.php?edit_title=<?php echo $political_title; ?>" style="float:right;font-size:15px;color:blue;margin-right:20px;">Edit</a></h1></a>
