				...
				<div class="nav-wrapper"> 
					<div class='nav-container clearfix'>
						<ul class="sf-menu" id="sf-menu">
							...
							<li class="menu_item-home current"><a href="all_movies.php"><i class="fa fa-film"></i> Movies</a></li>
									...
									<li>
										<article> 
											<div class="slider_title">
												...
												<h2><a href="single_movie_post.php?movie_title=<?php echo $movie_title; ?>"><?php echo $movie_title; ?></a></h2>
											</div>
					...
					<div class="prl-homepage-widget">
						...
						?>	<div class="prl-span-6">
								<div class="prl-post-content">
									<a  href="single_movie_post.php?movie_title=<?php echo $movie_title; ?>" class="prl-thumbnail">
										<span class="prl-overlay">
											<img src="movie_articles/<?php echo $movie_cover; ?>" alt="Test">
											<span class="prl-overlay-area o-photo"></span>
										</span>
									</a>    
									<h3><a href="single_movie_post.php?movie_title=<?php echo $movie_title; ?>"><?php echo $movie_title; ?></a> <span class="prl-badge prl-badge-warning" style="font-weight:normal">Images</span></h3> 
