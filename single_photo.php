			...
			<div class="prl-grid prl-grid-divider">
				<section id="main" class="prl-span-9">
					<div class="prl-homepage-widget">
						<h5 class="prl-block-title alizarin">Gallery</h5>
						...
						<div class="prl-grid prl-grid-divider"> 
							...
							<div class="prl-span-3">
								<div class="prl-post-content">
									<a  href="#" class="prl-thumbnail">
										<span class="prl-overlay">
											<a class="example-image-link" href="images/6.jpg" data-lightbox="example-set" data-title="Click the right half of the image to move forward."><img class="example-image" src="images/6.jpg" alt=""/></a>
										</span>
									</a>
									<br>
								</div>
