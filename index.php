				...
				<div class="nav-wrapper"> 
					<div class='nav-container clearfix'>
						<ul class="sf-menu" id="sf-menu">
							<li class="menu_item-home current"><a href="index.php"><i class="fa fa-home"></i> Home</a>
			...
			<div class="prl-grid prl-grid-divider">
				<section id="main" class="prl-span-9"> 
					<div id="sliderTab">
						<div id="mainFlexslider" class="slider_content flexslider" >
							...
							<?php
								...
								$movie_scroll =  new Article;
								$movie_scroller = $movie_scroll->fetch_movie_article_all();
								$i=0;
								foreach($movie_scroller as $movie_scroll)
								{
									if($i == 3)
									{	break; }
										
									$movie_title = $movie_scroll['movie_title'];
										$count = new Article;
									...
									$movie_description = $movie_scroll['movie_description'];
									$movie_image = $movie_scroll['movie_image'];
									$array = explode(',', $movie_image);
									$movie_cover = $array[0];
									$movie_tags = $movie_scroll['movie_tags'];
									$tags = explode(',', $movie_tags);
									$movie_time_stamp = $movie_scroll['movie_time_stamp'];
							?>
									<li>
										<article> 
											<div class="slider_title">
												...
												<h2><a href="single_movie_post.php?movie_title=<?php echo $movie_title; ?>"><?php echo $i.$movie_title; ?></a></h2>
											</div>
											<a href="single_movie_post.php?movie_title=<?php echo $movie_title; ?>"><img src="movie_articles/<?php echo $movie_cover; ?>" alt="slider"></a>
									   </article>
									</li>
						<?php		$i++;
								}	?>
						...
						<div class="slider_tabs">
							<ul class="tabs" id="main-slider-control-nav">
								...
								foreach($movie_scroller as $movie_scroll)
								{
									...
									{	break; }
							?>
									<li><div class="tab_content"><a href="#"><?php echo $movie_title; ?></a></div></li>
						<?php		$i++;
								}	?>
						<?php
					...
					<div class="prl-panel homepage-widget-tab">
						...
						<h5 class="prl-block-title sienna">Latest Cinema-Industry Updates <span class="prl-block-title-link right"><a href="all_movies.php">ALL POSTS <i class="fa fa-caret-right"></i></a></span></h5>
						
						<ul class="prl-tab" data-prl-tab="{connect:'#content1'}">
							<li class="prl-active"><a href="#">MOST RATING POSTS</a></li>
							<li><a href="#">MOST VIEWED POSTS</a></li>
						</ul>
						...
						<ul id="content1" class="prl-switcher">
							...
							?>
									<div class="prl-span-4">
										<article class="prl-article">
											<a class="prl-thumbnail" href="single_movie_post.php?movie_title=<?php echo $movie_title; ?>">
												<span class="prl-overlay">
													<img src="movie_articles/<?php echo $movie_cover; ?>" alt="Test">
													<span class="prl-overlay-area o-photo"></span>
												</span>
											</a>
											<h3 class="prl-article-title"><a href="single_movie_post.php?movie_title=<?php echo $movie_title; ?>"><?php echo $movie_title; ?></a> <span class="prl-badge prl-badge-red">Images</span></h3> 
											...
											if (strlen($movie_description) > 500) {
												...
												// truncate string
												$stringCut = substr($movie_description, 0, 100);

												$movie_description = substr($stringCut, 0, strrpos($stringCut, ' '))."... <a href='single_movie_post.php?movie_title=$movie_title'>Read More</a>"; 
											}
										?>
							...
							<li>
								...
								$movie_scroll =  new Article;
								$movie_scroller = $movie_scroll->fetch_movie_article_allby_rating();
								$i=0;
								foreach($movie_scroller as $movie_scroll)
								{
									$movie_title = $movie_scroll['movie_title'];
					...
					<div class="prl-panel homepage-widget-tab">
						...
						<h5 class="prl-block-title sienna">Latest Political Updates <span class="prl-block-title-link right"><a href="all_politicals.php">ALL POSTS <i class="fa fa-caret-right"></i></a></span></h5>
					
						<ul class="prl-tab" data-prl-tab="{connect:'#content2'}">
							<li class="prl-active"><a href="#">MOST RATING POSTS</a></li>
							<li><a href="#">MOST VIEWED POSTS</a></li>
						</ul>
						
						<ul id="content2" class="prl-switcher">
							<li>
								<div class="prl-grid prl-grid-divider">
								<?php
							...
							?>
									<div class="prl-span-4">
										<article class="prl-article">
											<a class="prl-thumbnail" href="single_movie_post.php?movie_title=<?php echo $political_title; ?>">
												<span class="prl-overlay">
													<img src="political_articles/<?php echo $political_cover; ?>" alt="Test">
													<span class="prl-overlay-area o-photo"></span>
												</span>
											</a>
											<h3 class="prl-article-title"><a href="single_movie_post.php?movie_title=<?php echo $political_title; ?>"><?php echo $political_title; ?></a> <span class="prl-badge prl-badge-red">Images</span></h3> 
											<div class="prl-article-meta clearfix">
											...
											if (strlen($political_description) > 500) {
												...
												// truncate string
												$stringCut = substr($political_description, 0, 100);
							...
							<li>
								...
								$political_scroll =  new Article;
								$political_scroller = $political_scroll->fetch_political_article_allby_rating();
								$i=0;
								foreach($political_scroller as $political_scroll)
								{
									$political_title = $political_scroll['political_title'];
